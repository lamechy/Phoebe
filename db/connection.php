...
//for OOP uses
$mysqli=new mysqli("localhost","root","","phoebe");
//for imperative
$conn=mysqli_connect("localhost","root","","phoebe");
...
else
{
		...
		/*****************************************************************
			...
			Without uncrack(), most of the system checks will fail as it is the most called.
